const questionList = [
    ...
    {
        question: '3. Сколько в среднем длится инкубационный период коронавируса?',
        answers: [
    ...
    {
        question: '4. Какие наиболее распространённые симптомы при заражении коронавирусом?',
        answers: [
    ...
    {
        question: '5. Что в первую очередь следует делать для профилактики коронавируса в период карантина?',
        answers: [
    ...
    {
        question: '6. Какую болезнь вызывает коронавирус?',
        answers: [
    ...
    {
        question: '7. Сколько времени может находится коронавирус на поверхности предметов?',
        answers: [
    ...
    {
        question: '8. От куда взялся коронавирус?',
        answers: [
